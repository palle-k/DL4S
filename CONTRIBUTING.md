...
* Open an Issue at https://github.com/palle-k/DL4S/issues
...
* Go to https://github.com/palle-k/DL4S/pulls and open a new pull request with your changes.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/palle-k/DL4S/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/palle-k/DL4S/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
...
* Pull requests should be covered by a test: either by a previously-failing test, an existing test that covers the entire functionality of the submitted code, or new tests to verify any new/changed behavior. All tests must also pass and follow established conventions.
